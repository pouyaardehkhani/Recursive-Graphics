 ...
 * </p>
 * <p>
 * if you want the grayscale color use the HtreeGrayscale.java
 * </p>
 */
...
public class Htree {
    ...
    public static void draw(int n, double x, double y, double size) {
        ...
        //in here we change the pen color in every recursion.
        if (order==n){
            SetCurrentColor();
        }
        else {
    ...
    /**
     * we use this method for changing the pen RGB color randomly.
     */
    public static void SetCurrentColor(){
        StdDraw.setPenColor(randRed(),randGreen(),randBlue());
    }
    /**
     * we use this method for getting a random RED value of our color.
     * @return int This returns an int in range of (0-255).
     */
    public static int randRed(){
        return rand.nextInt(256);
    }
    /**
     * we use this method for getting a random Green value of our color.
     * @return int This returns an int in range of (0-255).
     */
    public static int randGreen(){
        return rand.nextInt(256);
    }
    /**
     * we use this method for getting a random Blue value of our color.
     * @return int This returns an int in range of (0-255).
     */
    public static int randBlue(){
        return rand.nextInt(256);
    }
